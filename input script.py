...
index_list = input('Please enter the names of the samples in analysis order separated by a comma. Blanks should include the term blank and '
                   'CaCO3 standards should include the term CaCO3')
index_list = index_list.split(',')
f.index = index_list

#add Measured Weights column

weights = input('Please enter the measured weights of all samples in ug, separated by a comma. Enter 0 for blanks and '
                'the CaCO3 standards as their measured weight multiplied by 0.9998')
...
#filter for dataframes of just blanks and just CaCO3 standards
