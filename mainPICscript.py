...
f = pd.read_csv(r"C:\Users\gemmaw4\OneDrive - University of Tasmania\Documents\CSV files\29022024.csv", header=None)  #import csv file
...
index_list = ['blank1','blank2','blank3','CaCO3 1','CaCO3 2','CaCO3 3','CaCO3 4','CaCO3 5','blank4','blank5','ref1','ref2',
            'blank6','blank7','1','2','3','4','5','6','blank8','7','8','9','10','11','blank9','CaCO3 6','blank10']
f.index = index_list

#add Measured Weights column

weights = [0,0,0,319.13616,1059.18812,2141.17168,2868.72614,3612.07744,0,0,1015.5,1982.1,0,0,2632.6,2120.9,
        3322.7,2831.0,2686.5,2064.2,0,2259.2,3100.4,2070.0,2580.5,2149.8,0,2070.49,0]
